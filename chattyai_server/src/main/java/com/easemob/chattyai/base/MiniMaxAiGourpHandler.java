...
@Slf4j
@Component
public class MiniMaxAiGourpHandler implements AiStrategy {
...
//        }
        ...
        String key = Constant.CHAT_GROUP_HISTORY_REDIS_KEY_PREFIX + sender + ":" + chatBot.getEaAccount();
        if (needContext) {
            //处理历史消息
